...
No fim destas três etapas, pretendemos ter uma plataforma pronta a usar em qualquer parte do Mundo, usando documentos JSON como base para a troca de informação entre 	\textit{webservice} e os dispositivos móveis.
